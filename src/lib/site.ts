...
/**
 * Required verbatim by the club's CIO agreement with the University. Shown on the About page.
 * Hardcoded rather than in the officer Sheet so it can't be edited away.
 */
export const UNIVERSITY_STATEMENT =
